...
const load = async function () {
  ...
  try {
    images = import.meta.glob([
      ...
      '/src/data/post/**/*.{jpeg,jpg,png,tiff,webp,gif,svg,JPEG,JPG,PNG,TIFF,WEBP,GIF,SVG}',
    ]);
...
export const findImage = async (
  ...
  // Relative paths or not within tracked directories
  if (!imagePath.startsWith('~/assets/images') && !imagePath.startsWith('~/data/post')) {
    return imagePath;
  }
