...
excerpt: NotebookLMは多機能ですが、資格試験の学習において本当に使えるのはごく一部です。効率重視のエンジニア視点で、使うべき「Sランク機能」と時間の無駄になる「Cランク機能」を冷徹に仕分けしました。
category: method
tags:
- NotebookLM
- 勉強法
...
image: ~/data/post/notebooklm-anystudy/cover.jpg
---
...
![three pillars of learning](~/data/post/notebooklm-anystudy/pillars.jpg)
